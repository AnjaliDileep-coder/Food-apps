    ...
    return (
        <View style={styles.container}>
            <View style={styles.head}>
                <TouchableOpacity>
                    <Icon name="arrow-back" size={30} color="#FDC913" onPress={() => navigation.navigate("Offer")} style={styles.menu} />
                </TouchableOpacity>
            ...
            <View style={styles.body}>
                ...
                <View style={styles.imagecontainer}>
                    <Text style={styles.input}>Image</Text>
