            ...
            <View style={styles.body}>
                ...
                <View style={styles.body1}>
                    ...
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 55, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 15-02-2021</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 24, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: Cash</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 5, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 78, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    ...
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 50, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: XYZ</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 80, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: +91 123456789</Text>
                    </View>
                    <View style={styles.data}>
                        <Text style={styles.text3}>Address</Text>
                        <Text style={{
                            paddingLeft: 67, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 41, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 9, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 102, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 38, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 90, fontSize: 15, fontFamily: 'semibold'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                </View>
