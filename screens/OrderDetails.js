            ...
            <View style={styles.body}>
                ...
                <View style={styles.body1}>
                    ...
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 6, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 77, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    ...
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 52, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: XYZ</Text>
                    </View>
                    <View style={styles.data}>
                    ...
                    <View style={styles.data}>
                        <Text style={styles.text3}>Address</Text>
                        <Text style={{
                            paddingLeft: 68, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: ABC</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 43, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 13, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 101, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
                        ...
                        <Text style={{
                            paddingLeft: 40, fontSize: 15, fontFamily: 'OpenSansRegular'
                            , color: '#696969'
                        }}>: 0.00</Text>
                    </View>
                    <View style={styles.data}>
